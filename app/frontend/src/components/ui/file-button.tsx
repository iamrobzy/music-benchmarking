...
export const FileUploadRoot = forwardRef<HTMLInputElement, FileUploadRootProps>(
  function FileUploadRoot(props, ref) {
    const { children, accept, onFileAccept } = props
    return (
      <ChakraFileUpload.Root accept={accept} onFileAccept={onFileAccept}>
        <ChakraFileUpload.HiddenInput ref={ref} />
        {children}
...
>(function FileUploadDropzone(props, ref) {
  ...
  return (
    <ChakraFileUpload.Dropzone ref={ref} width="400px">
...
export const FileUploadList = forwardRef<HTMLUListElement, FileUploadListProps>(
  function FileUploadList(props, ref) {
    const { showSize, clearable, files } = props
    ...
    return (
      <ChakraFileUpload.ItemGroup ref={ref}>
...
export const FileInput = forwardRef<HTMLButtonElement, FileInputProps>(
  function FileInput(props, ref) {
    ...
    const { placeholder = "Select file(s)" } = restProps
    return (
